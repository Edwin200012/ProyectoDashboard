...
<div style="width: 90%; margin-left: 5%;">
  ...
  <div style=" margin-left: 1%;">  
    ...
    <input maxlength="10" minlength="1" style="border-radius: 15px;" type="number" class="form-control" id="precio_servicios" name="precio_servicios" required placeholder="Precio" min="0">
